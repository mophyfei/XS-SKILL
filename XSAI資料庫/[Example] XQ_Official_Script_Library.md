...
└── sysjust-xq-xscript_preset/
    ...
    │   │   └── ArrayXDaySeries.xs
    │   ├── 交易相關/
    │   │   ├── CalcVWAPDistribution.xs
    │   │   └── EnterMarketCloseTime.xs
    │   ├── 價格取得/
    │   │   ├── AvgPrice.xs
    │   │   ├── CloseD.xs
    │   │   ├── CloseH.xs
    ...
    │   │   ├── DaysToExpiration.xs
    │   │   ├── FormatMQY.xs
    │   │   ├── GetBarOffsetForYears.xs
    │   │   ├── GetLastTradeDate.xs
    │   │   ├── LastDayOfMonth.xs
    │   │   └── NthDayOfMonth.xs
    │   ├── 期權相關/
    │   │   ├── BlackScholesModel.xs
    │   │   ├── BSDelta.xs
    │   │   ├── BSGamma.xs
    │   │   ├── BSPrice.xs
    │   │   ├── BSTheta.xs
    │   │   ├── BSVega.xs
    │   │   ├── DaysToExpirationTF.xs
    │   │   ├── HVolatility.xs
    │   │   ├── IVolatility.xs
    │   │   └── NormSDist.xs
    │   ├── 統計分析/
    ...
    │   │   ├── xfMin_CrossOver.xs
    │   │   ├── xfMin_CrossUnder.xs
    │   │   ├── xfMin_DirectionMovement.xs
    │   │   ├── xfMin_EMA.xs
    │   │   ├── xfMin_GetBoolean.xs
    │   │   ├── xfMin_GetCurrentBar.xs
    │   │   ├── xfMin_GetDTValue.xs
    │   │   ├── xfMin_GetValue.xs
    │   │   ├── xfMin_MACD.xs
    │   │   ├── xfmin_MTM.xs
    ...
    │   │   └── TrueCount.xs
    │   └── 量能相關/
    │       ├── DiffBidAskVolumeLxL.xs
    │       ├── DiffBidAskVolumeXL.xs
    │       ├── DiffTradeVolumeAtAskBid.xs
    │       └── DiffUpDownVolume.xs
    ├── 指標/
    │   ├── XQ技術指標/
    │   │   ├── 3-6 乖離率.xs
    ...
    │   ├── 技術指標/
    │   │   ├── %b指標.xs
    │   │   ├── adaptive price zone.xs
    │   │   ├── ado聚散擺盪平均線.xs
    │   │   ├── ADTM動態買賣氣指標.xs
    │   │   ├── Aroon.xs
    │   │   ├── ASI(Accumulation Swing Index)振動升降指標.xs
    │   │   ├── bandpass filter.xs
    │   │   ├── bband當沖操作指標.xs
    │   │   ├── BB指標.xs
    │   │   ├── BW MFI.xs
    ...
    │   │   ├── CMI市場波動指標.xs
    │   │   ├── CMO(錢德動量擺盪指標).xs
    │   │   ├── coppock indicator.xs
    │   │   ├── CPC指標.xs
    │   │   ├── CR指標.xs
    │   │   ├── DBCD 異同離差乖離率 .xs
    │   │   ├── demand index.xs
    │   │   ├── DMI.xs
    │   │   ├── ease of movement指標.xs
    │   │   ├── Elder 多頭力道指標.xs
    │   │   ├── Elder 空頭力道指標.xs
    │   │   ├── EMA-SMA.xs
    │   │   ├── empirical mode decomposition.xs
    │   │   ├── extracting the trend.xs
    │   │   ├── HV歷史波動率指標.xs
    │   │   ├── IMI日內動能指標.xs
    │   │   ├── KO能量潮指標.xs
    │   │   ├── K棒衍生指標.xs
    ...
    │   ├── 0-基本語法/
    │   │   ├── 01-SetPosition.xs
    │   │   ├── 02-SetPosition範例#1(多單1口).xs
    │   │   ├── 02-SetPosition範例#2(空單1口).xs
    │   │   ├── 02-SetPosition範例#3(多單1口+空單1口).xs
    │   │   ├── 03-Filled.xs
    │   │   ├── 04-SetPosition範例#4(追價).xs
    │   │   ├── 04-SetPosition範例#5(加碼).xs
    │   │   ├── 05-FilledAvgPrice以及停損停利範例.xs
    │   │   ├── 06-FilledRecord函數.xs
    │   │   ├── 07-Position跟Filled的異動時機點.xs
    │   │   ├── 08-Alert.xs
    │   │   └── 09-CancelAllOrders.xs
    │   ├── 1-常用下單方式/
    │   │   ├── 01-市價交易.xs
    │   │   ├── 02-金額換算.xs
    │   │   ├── 03-全部賣出.xs
    ...
    └── 選股/
        ...
        │   ├── 葛拉罕的選股兩標準.xs
        │   ├── 說好的好業績一直沒有來.xs
        │   ├── 資產報酬率達到一定的水準且沒有明顯下滑.xs
        │   ├── 近N年EPS成長率平均大於X%.xs
        │   ├── 近五年至少有一年營業利益超過五億.xs
        │   ├── 近四季EPS合計大於N元.xs
        │   ├── 近期有大額資本支出.xs
        │   ├── 過去三年來自營運的現金流量都大於零.xs
        │   ├── 預估殖利率高的.xs
        │   ├── 預期報酬率高的公司.xs
        │   ├── 高F_Score的股票.xs
        │   ├── 高毛利低獲利營收暴衝.xs
